        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" @submit.prevent="formData.id == undefined ? store : update">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" :class="formErrors.stock_area_id ? 'has-error' : ''">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stock_area_id">Stock Area
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select2 :options="stock_areas" v-model="formData.stock_area_id" data-placeholder="Stock Area">
                            </select2>
