...
<div class="panel panel-primary" id="app">
    <div class="panel-body">
        <h3 class="pull-left text-primary">TERMINAL ABSENSI <small>Manage</small></h3>
        @can('create', App\TerminalAbsensi::class)
    ...
    @can('createOrUpdate', App\TerminalAbsensi::class)
    @include('terminalAbsensi._form')
    @endcan
...
<script type="text/javascript">
    ...
    const app = new Vue({
        ...
        methods: {
            add: function() {
                // reset the form
                this.formTitle = "ADD TERMINAL ABSENSI";
                this.formData = {};
                this.formErrors = {};
                this.error = {};
                // open form
            ...
            delete: function(id) {
                bootbox.confirm({
                    ...
                    callback: function(r) {
                        if (r == true) {
                            axios.delete('{{url("terminalAbsensi")}}/' + id)
        ...
        mounted: function() {
            ...
            var grid = $('#bootgrid').bootgrid({
                ...
                ajax: true, url: '{{url('terminalAbsensi')}}',
                ajaxSettings: {
                ...
                formatters: {
                    "commands": function(column, row) {
                        var t = t;
                        return '@can("update", App\TerminalAbsensi::class) <a href="#" class="btn btn-info btn-xs c-edit" data-id="'+row.id+'"><i class="icon-pencil"></i></a> @endcan ' +
                            '@can("delete", App\TerminalAbsensi::class) <a href="#" class="btn btn-danger btn-xs c-delete" data-id="'+row.id+'"><i class="icon-trash"></i></a> @endcan';
                    }
                }
