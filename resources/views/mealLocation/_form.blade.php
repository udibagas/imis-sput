            ...
            <form class="form-horizontal" role="form" @submit.prevent="formData.id == undefined ? store : update">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" :class="formErrors.user_id ? 'has-error' : ''">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="user_id">Penanggungjawab
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select2 v-model="formData.user_id" :options="users" data-placeholder="Penanggungjawab">
                            </select2>
