...
<div class="panel panel-primary" id="app">
    <div class="panel-body">
        <h3 class="pull-left text-primary">PRODUCTIVITY PLAN <small>Manage</small></h3>
        @can('create', App\ProductivityPlan::class)
    ...
    @can('createOrUpdate', App\ProductivityPlan::class)
    @include('productivityPlan._form')
    @endcan
...
<script type="text/javascript">
    ...
    const app = new Vue({
        ...
        methods: {
            add: function() {
                // reset the form
                this.formTitle = "ADD PRODUCTIVITY PLAN";
                this.formData = {};
                this.formErrors = {};
                this.error = {};
                // open form
            ...
            store: function() {
                block('form');
                var t = this;
                axios.post('{{url("productivityPlan")}}', this.formData).then(function(r) {
                    unblock('form');
            ...
            edit: function(id) {
                var t = this;
                this.formTitle = "EDIT PRODUCTIVITY PLAN";
                this.formErrors = {};
                this.error = {};

                axios.get('{{url("productivityPlan")}}/' + id).then(function(r) {
                    t.formData = r.data;
                    $('#modal-form').modal('show');
                })
            ...
            update: function() {
                block('form');
                var t = this;
                axios.put('{{url("productivityPlan")}}/' + this.formData.id, this.formData).then(function(r) {
                    unblock('form');
                    $('#modal-form').modal('hide');
            ...
            delete: function(id) {
                bootbox.confirm({
                    ...
                    callback: function(r) {
                        if (r == true) {
                            axios.delete('{{url("productivityPlan")}}/' + id)
        ...
        mounted: function() {
            ...
            var grid = $('#bootgrid').bootgrid({
                ...
                ajax: true, url: '{{url('productivityPlan')}}',
                ajaxSettings: {
