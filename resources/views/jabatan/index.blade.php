...
<div class="panel panel-primary" id="app">
    <div class="panel-body">
        <h3 class="pull-left text-primary">JABATAN <small>Manage</small></h3>
        ...
        <table class="table table-striped table-hover " id="bootgrid" style="border-top:2px solid #ddd">
            <thead>
                <tr>
                    ...
                    @can('updateOrDelete', App\Jabatan::class)
    ...
    @can('createOrUpdate', App\Jabatan::class)
...
<script type="text/javascript">
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            edit: function(id) {
                var t = this;
                this.formTitle = "EDIT JABATAN";
                this.formErrors = {};
                this.error = {};

                axios.get('{{url("jabatan")}}/' + id).then(function(r) {
                    t.formData = r.data;
                    $('#modal-form').modal('show');
                })
            ...
            var grid = $('#bootgrid').bootgrid({
                ...
                formatters: {
                    "commands": function(column, row) {
                        var t = t;
                        return '@can("update", App\Jabatan::class) <a href="#" class="btn btn-info btn-xs c-edit" data-id="'+row.id+'"><i class="icon-pencil"></i></a> @endcan' +
                            '@can("delete", App\Jabatan::class) <a href="#" class="btn btn-danger btn-xs c-delete" data-id="'+row.id+'"><i class="icon-trash"></i></a> @endcan';
                    }
                }
