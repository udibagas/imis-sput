...
<div class="panel panel-primary" id="app">
    <div class="panel-body">
        <h3 class="pull-left text-primary">UNIT CATEGORY <small>Manage</small></h3>
        @can('create', App\UnitCategory::class)
        ...
        <table class="table table-striped table-hover " id="bootgrid" style="border-top:2px solid #ddd">
            <thead>
                <tr>
                    ...
                    @can('updateOrDelete', App\UnitCategory::class)
    ...
    @can('createOrUpdate', App\UnitCategory::class)
    @include('unitCategory._form')
    @endcan
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            store: function() {
                block('form');
                var t = this;
                axios.post('{{url("unitCategory")}}', this.formData).then(function(r) {
                    unblock('form');
        ...
        mounted: function() {
            ...
            var grid = $('#bootgrid').bootgrid({
                ...
                ajax: true, url: '{{url('unitCategory')}}',
                ajaxSettings: {
                ...
                formatters: {
                    "commands": function(column, row) {
                        var t = t;
                        return '@can("update", App\UnitCategory::class) <a href="#" class="btn btn-info btn-xs c-edit" data-id="'+row.id+'"><i class="icon-pencil"></i></a> @endcan' +
                            '@can("delete", App\UnitCategory::class) <a href="#" class="btn btn-danger btn-xs c-delete" data-id="'+row.id+'"><i class="icon-trash"></i></a> @endcan';
                    }
                }
