        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" @submit.prevent="formData.id == undefined ? store : update">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" :class="formErrors.stock ? 'has-error' : ''">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="stock">Stock
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="number" v-model="formData.stock" class="form-control" placeholder="Stock">
                            <span v-if="formErrors.stock" class="help-block">@{{formErrors.stock[0]}}</span>
                        </div>
                    </div>
